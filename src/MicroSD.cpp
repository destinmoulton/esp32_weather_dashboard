...
void MicroSD::begin()
{
  ...
  {
    Serial.println("MicroSD::begin() failed to start SD card.");
  }
...
void MicroSD::listDir(fs::FS& fs, const char* dirname, uint8_t levels)
{
...
void MicroSD::renameFile(fs::FS& fs, const char* path1, const char* path2)
{
...
void MicroSD::deleteFile(fs::FS& fs, const char* path)
{
